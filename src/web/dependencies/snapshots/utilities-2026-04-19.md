...
<head>
    ...
    <title>Utilities for LSPs</title>
    <meta name="description" content="If you are missing a utility please create a pull request in GitHub against this markdown document">
    ...
    <link rel="canonical" href="https://microsoft.github.io/language-server-protocol/implementors/utilities/">
        ...
        <div class="col-12 col-lg-8" role="navigation" aria-label="Main">
            <nav id="small-nav" class="docs-nav d-lg-none">
                ...
                <select name="implementors" id="small-nav-dropdown">
                    ...
                    <option value="/language-server-protocol/implementors/utilities/" selected >Utilities</option>
                    
                </select>
            </nav>

            <h1>Implementations</h1>
            <h2>Utilities for LSPs</h2>
            <div id="markdown-content-container"><p><em>If you are missing a utility please create a pull request in GitHub against this markdown <a href="https://github.com/Microsoft/language-server-protocol/blob/gh-pages/_implementors/utilities.md">document</a></em></p>
...
<table class="table table-bordered table-responsive">
  ...
  <tbody>
    <tr>
      <td><a href="https://www.npmjs.com/package/lasponya">lasponya</a></td>
      <td><a href="https://github.com/picimako">Tamás Balog</a></td>
      <td><a href="https://github.com/picimako/lasponya">Lasponya</a></td>
      <td>TypeScript</td>
    </tr>
    <tr>
      <td><a href="https://lsp-devtools.readthedocs.io/en/latest/">lsp-devtools</a></td>
      <td><a href="https://github.com/alcarney">Alex Carney</a></td>
      <td><a href="https://github.com/swyddfa/lsp-devtools">lsp-devtools</a></td>
      <td>Python</td>
    </tr>
    <tr>
      <td><a href="https://www.npmjs.com/package/monaco-languageserver-types">monaco-languageserver-types</a></td>
      <td><a href="https://github.com/remcohaszing">Remco Haszing</a></td>
      <td><a href="https://github.com/remcohaszing/monaco-languageserver-types">monaco-languageserver-types</a></td>
      <td>TypeScript</td>
    </tr>
  </tbody>
</table>
